...
SECRET_KEY = 'django-insecure--tv)9)idt8k3qa%6w%zd*di9$-5xlk)znq%$!h=aw)(jmwv@s='
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'static' # This path is for collectstatic
STATICFILES_DIRS = [
    'shopkart/static',
] # This path for helping django to search the static files for collectstatic
